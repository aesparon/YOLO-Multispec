...
**YOLO-MultiSpectral** is a deep learning framework based on YOLO that supports multispectral imagery with 4+ (RGB + NIR + RedEdge, etc) for advanced object detection and instance segmentation. This project integrates spectral attention mechanisms like CBAM and is designed for use in remote sensing, agriculture, and environmental monitoring.
